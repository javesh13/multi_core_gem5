...
export INST_COUNT=1000000 #1 million
...
echo "Starting"
#./use.sh cpu_number <trace_file_name> | process.py <output_file_name>  
echo "Decompressing and collecting data"
./use.sh 0  $TRACE_OUTPUT | python3 process_data_i_on_fly.py $GEM5_DIR/benchmarks/$BM/trace_files/uncompressed_$BM.$INST_COUNT

echo "Processing Phase 2"
python3 ./process_data_ii.py $GEM5_DIR/benchmarks/$BM/trace_files/uncompressed_$BM.$INST_COUNT